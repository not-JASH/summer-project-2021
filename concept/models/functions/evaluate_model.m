function evaluate_model(sample,model,window_size,prediction_length)
    ...
    for i = 1:legnth(sample.data)
        ...
        if ~isempty(ls)
            ...
            elseif ls
                ...
                print("minute %d, long, delta: %.2f, accuracy: %.2f\n",i,delta,100*wins/(wins+losses));
            elseif ~ls
                temp = exit-entry;
                temp = temp/entry;
                ...
                print("minute %d, short, delta: %.2f, accuracy: %.2f\n",i,delta,100*wins/(wins+losses));
            end
        end        
    end
