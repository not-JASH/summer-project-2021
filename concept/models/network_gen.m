...
%     yVal = to_categorical(yVal);
    ...
    [results(i,1),results(i,2),results(i,3),results(i,4),lists{i}] = ...
        evaluate_model(train_samples{1},models{i},window_size,prediction_length,false,false,-5,confidence_interval,heuristic_limit); 
    fprintf("\nEvaluation on Evaluation Set ( time = training set end -> training set end + %d minutes)\n",time_after);
    [results(i,1),results(i,2),results(i,3),results(i,4),lists{i}] = ...
        evaluate_model(eval_samples{1},models{i},window_size,prediction_length,false,false,-5,confidence_interval,heuristic_limit); 
